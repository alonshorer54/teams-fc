...
/**
 * ההגרלה כפי שהסטטיסטיקות והמגמות סופרות אותה: רק מי שעדיין במאגר. שחקן שנמחק
 * נשאר ברשומה ובכרטיס של הערב — מחיקה מהמאגר לא משכתבת את העבר — אבל לא נספר
 * יותר. משלימים נשארים: הם חלק מהערב ומעולם לא היו במאגר.
 */
